...
import org.una.examen.service.IDistritoService;
...
public class DistritoController {
    ...
    public ResponseEntity<?> create(@RequestBody DistritoDTO distrito) {
        try {
            return new ResponseEntity<>(service.create(distrito), HttpStatus.CREATED);
        } catch (Exception e) {
    ...
    @PutMapping("/edit/{id}")
    @ResponseBody
    public ResponseEntity<?> update(@PathVariable(value = "id") Long id, @RequestBody DistritoDTO distrito) {
        try {
            Optional<DistritoDTO> distritoUpdated = service.update(distrito, id);
